...
`GET /api/v1/accounts/{accountId}/threads/{threadId}`

Get a complete email thread by its provider ID.
...
| `threadId` | path | Yes | `string` | Minimum length: 1. |

## Responses

| Status | Description | Content type |
| --- | --- | --- |
| `200` | Thread | `application/json` |
