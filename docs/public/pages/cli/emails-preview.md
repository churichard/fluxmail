---
title: 'fluxmail emails preview'
description: 'Preview sender, recipients, and attachments'
updated: '2026-07-15'
---

<!-- This page is generated from the CLI command definitions. Run pnpm docs:generate to update it. -->

`fluxmail emails preview`

Preview sender, recipients, and attachments

## Usage

```bash
fluxmail emails preview [options]
```
...
| `--draft <draft-id>` | No | Preview an existing draft | None |
